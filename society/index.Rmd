...
Rather than splitting the data into whether or not the respondents have previously participated in outreach, the data are split based on responses to the question "Does the funding body you report to / your institution reports to require participation in outreach?"
